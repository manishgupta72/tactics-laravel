...
@include('front.IncludesFiles.page-title', ['title' => 'Contract Staffing'])
                ...
                <div class="col-lg-3 border-all py-4 position-relative">
                    <aside class="sidebar" id="sidebar" data-plugin-sticky
                        ...
                        <ul class="nav nav-list flex-column mb-0 p-relative right-9">
                            <li class="nav-item">
                                <a class="nav-link font-weight-bold text-dark text-3 border-0 my-1 p-relative"
                                    href="/tactics/contract">Contract Staffing</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link font-weight-bold text-dark text-3 border-0 my-1 p-relative"
                                    href="/tactics/permanent">Permanent Staffing</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link font-weight-bold text-dark text-3 border-0 my-1 p-relative"
                                    href="/tactics/payroll">Payroll Outsourcing</a>
                            </li>
                        </ul>
                        ...
                        <div class="feature-box feature-box-style-2 mb-4">
                            ...
                            <div class="feature-box-info">
                                ...
                                <p class="m-0"><a
                                        href="mailto:{{get_settings('general_settings', 'support_email')}}">{{get_settings('general_settings', 'support_email')}}</a>
                                </p>
                            </div>
                        </div>
                        <div class="feature-box feature-box-style-2 mb-4">
                            ...
                            <div class="card border-0 border-radius-0 box-shadow-1 appear-animation animated fadeInUpShorter appear-animation-visible"
                                ...
                                <div class="card-body p-3 z-index-1">
                                    <img class="card-img-top border-radius-0"
                                        src="{{ $aboutMediaFiles->isNotEmpty() ? asset('assets/media_files/' . $aboutMediaFiles->first()->mf_image) : 'https://placehold.co/372x274' }}"
                                        alt="Card Image">
                                </div>
                            </div>
                        </div>
