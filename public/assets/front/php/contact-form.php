...
try {
	...
	$mail->Host = 'mail.rbtcrm.in';				       // Specify main and backup server

	$mail->SMTPAuth = true;                                  // Enable SMTP authentication

	$mail->Username = 'email@rbtcrm.in';                    // SMTP username

	$mail->Password = 'Rbt@sol98198#';                              // SMTP password
